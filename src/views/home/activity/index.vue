  ...
  <div class="activity">
    <div class="navigator">
      <div class="navigator-inner-container">
        ...
        <p class="navigator-title">活动列表</p>
      </div>
    </div>
    <ul class="activity-list">
      ...
      <li class="activity-item">
        <div class="image-icon-container">
          <img class="icon" src="../../../assets/turntable.png" />
        </div>
        <div class="activity-content">
          <p class="label">积分大转盘</p>
          <img class="angle" src="../../../assets/angle-right-grey.png" />
        </div>
      </li>
      <li class="activity-item">
    ...
    <div class="my-integration">
      ...
      <p class="integration-value">500分</p>
    </div>
    <div class="information-container">
      <div class="information">
        <div class="information-tip">
          <img class="warn" src="../../../assets/warn.png" />
          <p>完善您的信息，即可获得10积分。请确保 信息准确，以便后续兑换礼品。</p>
        </div>
        <information-input label="姓名" placeholder="请输入姓名" />
        <information-input label="生日" placeholder="请选择生日" />
        <information-input label="手机" placeholder="请输入手机号码" />
